    ...
    <div className="flex h-screen overflow-hidden bg-[var(--bg-1)]">
      ...
      <aside
          ...
          <div className="px-4 py-4 border-b border-[var(--border)]">
            <div className="flex items-center gap-3">
              ...
              <div className="min-w-0">
                <div className="text-sm font-bold text-[var(--text-1)] truncate">{profile.full_name ?? profile.username}</div>
        ...
        <div className="p-4 border-t border-[var(--border)]">
          <Link href="/settings"
            className="flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-semibold text-[var(--text-2)] hover:bg-[var(--bg-3)] transition-colors">
            ⚙️ Settings
          </Link>
        </div>
      </aside>
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        {/* Top bar */}
        <header className="h-16 flex items-center justify-between px-6 border-b border-[var(--border)] bg-[var(--bg-1)]/80 backdrop-blur-md">
          <button
          ...
          <div className="flex items-center gap-3">
            <span className="text-xs font-bold text-[var(--text-3)] hidden sm:block">🔥 {streakDays} day streak</span>
            <button
              aria-label="Notifications"
              className="relative p-2 rounded-lg border border-[var(--border)] text-[var(--text-2)] hover:border-brand/40 transition-colors"
            >
              🔔
