...
const ALL: Testimonial[] = [
  ...
  { name: "Rahul Kumar",   role: "Full Stack Intern @ Swiggy", initials: "RK", accent: "#f97316", text: "I went from zero coding knowledge to landing a paid internship in 4 months. The structured tracks and real-world projects made all the difference." },
  ...
  { name: "Shreya Menon",  role: "SWE @ Flipkart",            initials: "SM", accent: "#7c3aed", text: "The weekly contests are genuinely competitive. Finishing in the top 10 gave me confidence to crack product-based company rounds with ease." },
  { name: "Karthik Iyer",  role: "AI/ML Intern @ Juspay",     initials: "KI", accent: "#ea580c", text: "The AI mock interviewer asked me the exact same questions that came up in my actual interview. It's like they have insider knowledge!" },
  { name: "Divya Rao",    role: "Full Stack Dev @ Groww",     initials: "DR", accent: "#0891b2", text: "Upgradian's internship program connected me directly with startups. I got real project experience, a stipend, and a full-time offer afterward." },
];
...
function Card({ t }: { t: Testimonial }) {
  return (
    <div className="flex-shrink-0 w-[300px] sm:w-[320px] rounded-2xl p-5 flex flex-col bg-white border border-slate-200 shadow-sm">
      {/* Stars */}
      ...
      <div className="flex items-center gap-3">
        ...
        <div>
          <div className="text-sm font-bold text-slate-900 leading-none mb-0.5">{t.name}</div>
...
function MarqueeRow({ items, reverse }: { items: Testimonial[]; reverse?: boolean }) {
  return (
    <div className="relative overflow-hidden">
      <div className="absolute inset-y-0 left-0 z-10 w-24 pointer-events-none" style={{ background: "linear-gradient(90deg, #f8fafc, transparent)" }} />
      <div className="absolute inset-y-0 right-0 z-10 w-24 pointer-events-none" style={{ background: "linear-gradient(-90deg, #f8fafc, transparent)" }} />
      <div
...
export function TestimonialsSection() {
  return (
    <section id="about" className="relative py-28 overflow-hidden bg-slate-50">
      <div className="absolute inset-0 pointer-events-none" style={{ background: "radial-gradient(ellipse 60% 40% at 50% 0%, rgba(249,115,22,0.04), transparent)" }} />
