          ...
          <div className="col-span-2 md:col-span-1">
            ...
            <div className="flex items-center gap-2.5 mt-5">
              ...
              <a
                ...
                className="w-8 h-8 rounded-lg flex items-center justify-center transition-all hover:scale-110 border border-white/[0.07] bg-white/[0.03] text-white/40 hover:text-white hover:border-white/20"
              >
            ...
            <div key={title}>
              ...
              <ul className="space-y-3">
                {links.map(([label, href]) => (
                  <li key={label}>
                    <Link href={href} className="text-sm text-white/35 hover:text-white transition-colors">
                      {label}
                    </Link>
                  </li>
                ))}
