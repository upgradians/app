  ...
  return (
    <div className="p-6 max-w-6xl mx-auto space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-extrabold text-[var(--text-1)] tracking-tight">
            Missions <span className="text-brand">🎯</span>
          </h1>
          <p className="text-[var(--text-2)] mt-1 text-sm">Manage weekly and daily missions</p>
        </div>
        <Link
      ...
      <div className="bg-[var(--bg-2)] border border-[var(--border)] rounded-2xl p-12 text-center">
        ...
        <h2 className="font-bold text-[var(--text-1)] mb-2">Mission Management</h2>
        <p className="text-sm text-[var(--text-3)] max-w-sm mx-auto">
          Mission creation and management coming soon. Use the database directly in the meantime.
        </p>
      </div>
    </div>
  );
